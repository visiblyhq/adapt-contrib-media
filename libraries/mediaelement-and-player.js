  ...
  createPlugin: function (
    ...
    if (playback.method === "flash" || playback.method === "silverlight") {
      ...
      window[pluginid + "_init"] = function () {
        ...
        if (
          pluginMediaElement.pluginApi != null &&
...
mejs.YouTubeApi = {
  ...
  createEvent: function (player, pluginMediaElement, eventName) {
    ...
    if (player && player.getDuration) {
      ...
      var bufferedTime =
        (event.bufferedBytes / event.bytesTotal) * event.duration;
...
(function ($) {
  ...
  mejs.MediaElementPlayer.prototype = {
        ...
        t.container = $(
          ...
          .focus(function (e) {
            if (!t.controlsAreVisible) {
              t.showControls(true);
              var playButton = t.container.find(
    ...
    setPoster: function (url) {
      ...
      if (posterImg.length === 0) {
        posterImg = $('<img width="100%" height="100%" alt="" />').appendTo(
          posterDiv
        );
      }
  ...
  (function () {
    ...
    mejs.MediaElementPlayer.prototype.globalBind = function (
      events,
      data,
      callback
    ) {
    ...
    mejs.MediaElementPlayer.prototype.globalUnbind = function (
      events,
      callback
    ) {
      var t = this;
        ...
        handleMouseMove = function (e) {
          ...
          if (media.duration) {
            ...
            if (!mejs.MediaFeatures.hasTouch) {
              ...
              timefloatcurrent.html(
                mejs.Utility.secondsToTimeCode(newTime, player.options)
              );
              timefloat.show();
            }
          }
      ...
      if (t.media.currentTime !== undefined && t.media.duration) {
        ...
        if (t.total && t.handle) {
          var newWidth = Math.round(
              (t.total.width() * t.media.currentTime) / t.media.duration
            ),
        ...
        positionVolumeHandle = function (volume, secondTry) {
          ...
          if (mode == "vertical") {
            ...
            volumeHandle.css(
              "left",
              Math.round(
                totalPosition.left + newLeft - volumeHandle.width() / 2
              )
            );
      ...
      var fullscreenIsDisabled = false,
        ...
        positionHoverDivs = function () {
          var fullScreenBtnOffsetLeft =
              fullscreenBtn.offset().left - t.container.offset().left,
            fullScreenBtnOffsetTop =
              fullscreenBtn.offset().top - t.container.offset().top,
          ...
          hoverDivs["right"]
            .width(
              containerWidth - fullScreenBtnOffsetLeft - fullScreenBtnWidth
            )
            .height(fullScreenBtnHeight)
            .css({
          ...
          hoverDivs["bottom"]
            ...
            .height(
              containerHeight - fullScreenBtnHeight - fullScreenBtnOffsetTop
            )
      ...
      parse: function (trackText) {
        ...
        for (i = 0; i < lines.length; i++) {
          ...
          if (lines.eq(i).attr("begin"))
            _temp_times.start = mejs.Utility.convertSMPTEtoSeconds(
          ...
          if (lines.eq(i).attr("end"))
            _temp_times.stop = mejs.Utility.convertSMPTEtoSeconds(
              lines.eq(i).attr("end")
            );
  ...
  $.extend(MediaElementPlayer.prototype, {
    buildskipback: function (player, controls, layers, media) {
      var t = this,
        ...
        backText = t.options.skipBackText.replace(
          "%1",
        ...
        loop = $(
          ...
          .click(function () {
            media.setCurrentTime(
              Math.max(media.currentTime - t.options.skipBackInterval, 0)
            );
